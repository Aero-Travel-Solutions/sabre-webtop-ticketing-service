...
namespace SessionCreate
{
    ...
    public partial class SessionCreateRQRequest
    {
        ...
        public SessionCreate.MessageHeader MessageHeader;

        [System.ServiceModel.MessageHeaderAttribute(Namespace = "http://schemas.xmlsoap.org/ws/2002/12/secext")]
        public SessionCreate.Security Security;

        [System.ServiceModel.MessageBodyMemberAttribute(Namespace = "http://www.opentravel.org/OTA/2002/11", Order = 0)]
        public SessionCreate.SessionCreateRQ SessionCreateRQ;

        public SessionCreateRQRequest()
        {
        }

        public SessionCreateRQRequest(SessionCreate.MessageHeader MessageHeader, SessionCreate.Security Security, SessionCreate.SessionCreateRQ SessionCreateRQ)
        {
    ...
    public partial class SessionCreateRQResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace = "http://www.opentravel.org/OTA/2002/11", Order = 0)]
        public SessionCreate.SessionCreateRS SessionCreateRS;

        public SessionCreateRQResponse()
        {
        }

        public SessionCreateRQResponse(SessionCreate.MessageHeader MessageHeader, SessionCreate.Security Security, SessionCreate.SessionCreateRS SessionCreateRS)
        {
            this.MessageHeader = MessageHeader;
            this.Security = Security;
    ...
    public partial class SessionCreatePortTypeClient : System.ServiceModel.ClientBase<SessionCreate.SessionCreatePortType>, SessionCreate.SessionCreatePortType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<SessionCreate.SessionCreateRQResponse> SessionCreate.SessionCreatePortType.SessionCreateRQAsync(SessionCreate.SessionCreateRQRequest request)
        {
            return base.Channel.SessionCreateRQAsync(request);
        }

        public System.Threading.Tasks.Task<SessionCreate.SessionCreateRQResponse> SessionCreateRQAsync(SessionCreate.MessageHeader MessageHeader, SessionCreate.Security Security, SessionCreate.SessionCreateRQ SessionCreateRQ)
        {
            SessionCreate.SessionCreateRQRequest inValue = new SessionCreate.SessionCreateRQRequest();
            inValue.MessageHeader = MessageHeader;
            inValue.Security = Security;
            inValue.SessionCreateRQ = SessionCreateRQ;
            return ((SessionCreate.SessionCreatePortType)(this)).SessionCreateRQAsync(inValue);
        }
