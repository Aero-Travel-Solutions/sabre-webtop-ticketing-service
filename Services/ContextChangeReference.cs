...
namespace ContextChange
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://webservices.sabre.com/websvc", ConfigurationName="ContextChange.ContextChangePortType")]
    public interface ContextChangePortType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="ContextChangeLLSRQ", ReplyAction="*")]
        ...
        System.Threading.Tasks.Task<ContextChange.ContextChangeRQResponse> ContextChangeRQAsync(ContextChange.ContextChangeRQRequest request);
    }
    ...
    public partial class ContextChangeRQRequest
    {
        ...
        public ContextChange.MessageHeader MessageHeader;
        
        [System.ServiceModel.MessageHeaderAttribute(Namespace="http://schemas.xmlsoap.org/ws/2002/12/secext")]
        public ContextChange.Security1 Security;
        
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://webservices.sabre.com/sabreXML/2011/10", Order=0)]
        public ContextChange.ContextChangeRQ ContextChangeRQ;
        
        public ContextChangeRQRequest()
        {
        }
        
        public ContextChangeRQRequest(ContextChange.MessageHeader MessageHeader, ContextChange.Security1 Security, ContextChange.ContextChangeRQ ContextChangeRQ)
        {
    ...
    public partial class ContextChangeRQResponse
    {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://webservices.sabre.com/sabreXML/2011/10", Order=0)]
        public ContextChange.ContextChangeRS ContextChangeRS;
        
        public ContextChangeRQResponse()
        {
        }
        
        public ContextChangeRQResponse(ContextChange.MessageHeader MessageHeader, ContextChange.Security1 Security, ContextChange.ContextChangeRS ContextChangeRS)
        {
            this.MessageHeader = MessageHeader;
            this.Security = Security;
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public interface ContextChangePortTypeChannel : ContextChange.ContextChangePortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public partial class ContextChangePortTypeClient : System.ServiceModel.ClientBase<ContextChange.ContextChangePortType>, ContextChange.ContextChangePortType
    {
        ...
        public ContextChangePortTypeClient() : 
                base(ContextChangePortTypeClient.GetDefaultBinding(), ContextChangePortTypeClient.GetDefaultEndpointAddress())
        {
            this.Endpoint.Name = EndpointConfiguration.ContextChangePortType.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ContextChangePortTypeClient(EndpointConfiguration endpointConfiguration) : 
                base(ContextChangePortTypeClient.GetBindingForEndpoint(endpointConfiguration), ContextChangePortTypeClient.GetEndpointAddress(endpointConfiguration))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ContextChangePortTypeClient(EndpointConfiguration endpointConfiguration, string remoteAddress) : 
                base(ContextChangePortTypeClient.GetBindingForEndpoint(endpointConfiguration), new System.ServiceModel.EndpointAddress(remoteAddress))
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ContextChangePortTypeClient(EndpointConfiguration endpointConfiguration, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(ContextChangePortTypeClient.GetBindingForEndpoint(endpointConfiguration), remoteAddress)
        {
            this.Endpoint.Name = endpointConfiguration.ToString();
            ConfigureEndpoint(this.Endpoint, this.ClientCredentials);
        }
        
        public ContextChangePortTypeClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(binding, remoteAddress)
        {
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ContextChange.ContextChangeRQResponse> ContextChange.ContextChangePortType.ContextChangeRQAsync(ContextChange.ContextChangeRQRequest request)
        {
            return base.Channel.ContextChangeRQAsync(request);
        }
        
        public System.Threading.Tasks.Task<ContextChange.ContextChangeRQResponse> ContextChangeRQAsync(ContextChange.MessageHeader MessageHeader, ContextChange.Security1 Security, ContextChange.ContextChangeRQ ContextChangeRQ)
        {
            ContextChange.ContextChangeRQRequest inValue = new ContextChange.ContextChangeRQRequest();
            inValue.MessageHeader = MessageHeader;
            inValue.Security = Security;
            inValue.ContextChangeRQ = ContextChangeRQ;
            return ((ContextChange.ContextChangePortType)(this)).ContextChangeRQAsync(inValue);
        }
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.ContextChangePortType))
            {
        ...
        {
            return ContextChangePortTypeClient.GetBindingForEndpoint(EndpointConfiguration.ContextChangePortType);
        }
        
        private static System.ServiceModel.EndpointAddress GetDefaultEndpointAddress()
        {
            return ContextChangePortTypeClient.GetEndpointAddress(EndpointConfiguration.ContextChangePortType);
        }
